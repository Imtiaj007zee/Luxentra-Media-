    ...
    <div className="min-h-screen bg-white text-zinc-900">
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-zinc-200/50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#package" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">Package</a>
            <a href="#addons" className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors">Add-ons</a>
            <Link to="/order" className="text-sm bg-zinc-900 text-white px-4 py-2 rounded-full hover:bg-zinc-800 transition-all flex items-center gap-2">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden" style={{ transform: `scale(${scale})`, opacity }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center">
          <div className="inline-block mb-4 text-xs uppercase tracking-widest text-zinc-500 font-medium">Luxury Real Estate Media</div>
