    ...
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <h1
            className="text-6xl md:text-8xl lg:text-9xl font-semibold tracking-tight leading-none mb-8 bg-gradient-to-br from-zinc-900 via-zinc-700 to-zinc-900 bg-clip-text text-transparent drop-shadow-[0_8px_16px_rgba(0,0,0,0.12)]"
            style={{
      ...
      <section id="package" className="py-32 px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <div
              className="text-6xl md:text-8xl font-bold text-zinc-900 mb-4 bg-gradient-to-br from-zinc-900 via-zinc-700 to-zinc-900 bg-clip-text text-transparent drop-shadow-[0_4px_12px_rgba(0,0,0,0.1)]"
              style={{
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
              }}
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-zinc-50 rounded-3xl p-8 border border-zinc-200 hover:border-zinc-300 transition-all md:col-span-2">
      ...
      <section
        id="addons"
        className="py-32 px-6 lg:px-8 bg-gradient-to-b from-zinc-50 to-white"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block text-xs uppercase tracking-widest text-zinc-500 font-medium mb-4">
      ...
      <section className="py-32 px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2
            className="text-4xl md:text-5xl font-semibold tracking-tight mb-8 bg-gradient-to-br from-zinc-900 via-zinc-700 to-zinc-900 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
            style={{
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
      ...
      <section className="py-32 px-6 lg:px-8 bg-gradient-to-b from-zinc-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2
            className="text-5xl md:text-6xl font-semibold tracking-tight mb-8 bg-gradient-to-br from-zinc-900 via-zinc-700 to-zinc-900 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
            style={{
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}
